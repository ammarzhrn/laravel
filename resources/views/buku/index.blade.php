        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                    class="mx-6 my-4 block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button">
                    Add Book
                </button>
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="pengarang" id="name"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Type writer name" required="">
                                    </div>
                                    <div class="col-span-2">
                                        <label for="name"
